...
public class PodiumLandingPage {
    ...
    /**
     * Gets Feedback menu item web element
     *
     * @return : Webelement
     */
    public WebElement getFeedbackMenu() {
        return driver.findElement(Using.FEEDBACK_MENU_ITEM.selector);
    }
     ...
     * @return : Webelement
     */
    public WebElement getTeamChatMenu() {
        return driver.findElement(Using.TEAMCHAT_MENU_ITEM.selector);
    }

    /**
     * Gets Video Chat menu item web element
     *
     * @return : Webelement
     */
    public WebElement getVideoChatMenu() {
        return driver.findElement(Using.VIDEOCHAT_MENU_ITEM.selector);
    }

    /**
     * Gets Web Chat menu item web element
     *
     * @return : Webelement
     */
    public WebElement getWebChatMenu() {
        return driver.findElement(Using.WEBCHAT_MENU_ITEM.selector);
    }
     ...
     */
    public void playTraneVideo() throws InterruptedException {
     ...
     * @throws InterruptedException : if Thread is interrupted
     */
    public void playAustinCouchPotatoVideo() throws InterruptedException {
    ...
    private enum Using {
        ...
        FEEDBACK_MENU_ITEM(By.xpath("//a[@href='/feedback']//span[@class='submenu-thumbnail']")),
        PAYMENTS_MENU_ITEM(By.xpath("//a[@href='/payments']//span[@class='submenu-thumbnail']")),
        TEAMCHAT_MENU_ITEM(By.xpath("//a[@href='/teamchat']//span[@class='submenu-thumbnail']")),
        VIDEOCHAT_MENU_ITEM(By.xpath("//a[@href='/videochat']//span[@class='submenu-thumbnail']")),
        WEBCHAT_MENU_ITEM(By.xpath("//a[@href='/webchat']//span[@class='submenu-thumbnail']")),
